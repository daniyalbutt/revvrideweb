                    ...
                    <div class="dashboard-content-wrapper">
                        ...
                        <div class="row">
                            <div class="col-md-12 mt-3">
                                <form action="{{ route('vendor.tour.update', $data->id) }}" class="row" method="post" enctype="multipart/form-data">
                                    @csrf
                                    {{ method_field('PATCH') }}
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="datetime-local" id="start_date" name="start_date" class="form-control" required value="{{ $data->start_date }}">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label id="end_date">End Date</label>
                                        <input type="datetime-local" id="end_date" name="end_date" class="form-control" required value="{{ $data->end_date }}">
                                    </div>
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="number" name="age" id="age" class="form-control" required value="{{ $data->age }}">
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="duration">Duration</label>
                                        <input type="number" name="duration" id="duration" class="form-control" value="{{ $data->duration }}">
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label for="whats_include">What's Included</label>
                                        <textarea id="whats_include" name="whats_include" class="form-control" cols="20" rows="5">{{ $data->whats_include }}</textarea>
                                    </div>
                                    <div class="form-group col-md-12">
                                        <button class="btn btn-green-update">Update Tour</button>
                                    </div>
                                </form>
                            </div>
                        </div>
